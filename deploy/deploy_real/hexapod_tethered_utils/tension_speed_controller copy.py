...
class TensionSpeedControllerConfig:
    ...
    Kff_forward: float = 1.0  # Feedforward scaling factor (paper-style), unitless multiplier on ff_rpm
    Kff_backward: float = 1.0  # Feedforward scaling factor (paper-style), unitless multiplier on ff_rpm
...
class TensionSpeedController:
    ...
    def step(
        ...
        *,
        ...
        feedback_rpm = kp * e + kd * derivative
        self._last_error = e
