...
class Controller:
    def __init__(self,config:Config) -> None:
        ...
        # self.log_file_4 = open('motor_4_output.csv', 'w')
        # self.log_file_5 = open('motor_5_output.csv', 'w')
        # self.log_file_6 = open('motor_6_output.csv', 'w')
        # self.log_file_4.write("time_step,target_pos,action\n")
        # self.log_file_5.write("time_step,target_pos,action\n")
        # self.log_file_6.write("time_step,target_pos,action\n")
    ...
    # def __del__(self):
    #     try:
    #         self.log_file_4.close()
    #         self.log_file_5.close()
    #         self.log_file_6.close()
    #     except:
    #         pass
    ...
    def run(self):
        ...
        for i in range(18):
            ...
            # motor_id = self.config.joint2motor_idx[i]
            # if motor_id == 4:
            #     self.log_file_4.write(f"{self.counter},{q:.6f},{self.action[i]:.6f}\n")
            # elif motor_id == 5:
            #     self.log_file_5.write(f"{self.counter},{q:.6f},{self.action[i]:.6f}\n")
            # elif motor_id == 6:
            #     self.log_file_6.write(f"{self.counter},{q:.6f},{self.action[i]:.6f}\n")
